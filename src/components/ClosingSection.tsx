    ...
    <section className="relative py-20">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col items-start max-w-xl">
          <h2 className="text-white text-2xl md:text-3xl uppercase tracking-widest font-cormorant mb-2">Влюбитесь</h2>
          <h3 className="text-white text-3xl md:text-5xl uppercase tracking-wide font-cormorant mb-8">В ГОРЫ</h3>
          
          <p className="text-white text-base md:text-lg mb-8 leading-relaxed font-montserrat font-light">
            Мы команда единомышленников, которые любят исследовать горы. Мы знаем все тропы, лучшие виды и секретные места. Позвольте нам показать вам настоящую красоту гор.
          </p>
          
          <button className="btn-outline uppercase tracking-widest text-sm font-montserrat">
